...
import { Scenario, apiService } from '../services/api';
import { Play, User, Clock, Award } from 'lucide-react';
...
export const Dashboard: React.FC<DashboardProps> = ({ userEmail, onStartSession }) => {
