      ...
      <div className="max-w-lg w-full bg-white rounded-2xl shadow-xl p-8 border border-white/20">
        ...
        {process.env.NODE_ENV === 'development' && (
          <div className="mt-6 p-4 bg-gray-50 rounded-lg border">
            <p className="text-sm font-medium text-gray-700 mb-2">Development Tools:</p>
            <div className="space-y-2">
              ...
              <button
                ...
                className="text-sm bg-gray-200 hover:bg-gray-300 px-3 py-1 rounded text-gray-700 ml-2"
              >
                Check Environment
              </button>
            </div>
